...
export class PureAddButton extends React.Component {
    ...
    request = () => {
        axios.get(`http://api.open-notify.org/astros.json`).then(res => {
            ...
            let array = []
            let peopleInSpace = res.data.people
            let arrayOfNamesfunc = peopleInSpace.forEach(person =>
    ...
    render() {
        return (
            <div>
                ...
                <button onClick={this.request}>Make Axios Request</button>
                ...
                <Modal isOpen={this.state.modal} toggle={this.toggle}>
                    ...
                    <ModalFooter>
                        ...
                        <div id='spaceMen'>{this.state.spacemen}</div>
            </div>
        );
    }
